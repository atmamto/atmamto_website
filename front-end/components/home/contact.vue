<template>
    <div>
        <Divider dashed><h2 style="color: #c31313">Contact us</h2></Divider>
        <form action="">
            <Row>
                <Col span="8">
                ...
                <Button style="margin-top: 10px; background-color : #315777; border-color: #315777;" type="primary" @click.prevent="contact">Send Message</Button>
            </Row>
        </form>
    </div>
</template>
